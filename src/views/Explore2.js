                ...
                <div className="tab-content">
                    ...
                    <div className="tab-pane fade" id="tab-2" role="tabpanel">
                        <div className="row row--grid">
                            ...
                            <div className="col-12">
                                <div className="row row--grid collapse" id="collapsemore2">
                                    <div className="col-12 col-sm-6 col-lg-4 col-xl-3">
                            ...
                            <div className="col-12">
                                <button className="main__load" type="button" data-toggle="collapse" data-target="#collapsemore2" aria-expanded="false" aria-controls="collapsemore2">Load more</button>
                            </div>
                        ...
                        <div className="row row--grid">
                            ...
                            <div className="col-12 col-sm-6 col-lg-4 col-xl-3">
                                ...
                                <div className="card">
                                    ...
                                    <h3 className="card__title"><button>To Infinity And Beyond</button></h3>
                                    <div className="card__author card__author--verified">
                                        <img src="img/avatars/avatar2.jpg" alt="" />
                                        <Link to="/author">@johndoe</Link>
                                    </div>
                            ...
                            <div className="col-12 col-sm-6 col-lg-4 col-xl-3">
                                ...
                                <div className="card">
                                    ...
                                    <h3 className="card__title"><button>Flowers in Concrete (Modal)</button></h3>
                                    <div className="card__author">
                                        <img src="img/avatars/avatar4.jpg" alt="" />
                                        <Link to="/author">@min1max</Link>
                                    </div>
                            ...
                            <div className="col-12">
                                <div className="row row--grid collapse" id="collapsemore3">
                                    <div className="col-12 col-sm-6 col-lg-4 col-xl-3">
                            ...
                            <div className="col-12">
                                <button className="main__load" type="button" data-toggle="collapse" data-target="#collapsemore3" aria-expanded="false" aria-controls="collapsemore3">Load more</button>
                            </div>
                    ...
                    <div className="tab-pane fade" id="tab-4" role="tabpanel">
                        <div className="row row--grid">
                            ...
                            <div className="col-12">
                                <div className="row row--grid collapse" id="collapsemore4">
                                    <div className="col-12 col-sm-6 col-lg-4 col-xl-3">
                            ...
                            <div className="col-12">
                                <button className="main__load" type="button" data-toggle="collapse" data-target="#collapsemore4" aria-expanded="false" aria-controls="collapsemore4">Load more</button>
                            </div>
